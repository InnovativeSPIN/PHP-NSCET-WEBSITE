    ...
    <li class="nav-item">
      <a href="#">
        ...
        <section class="container">
            ...
            <hr>
            <div class="mx-5">
               <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">1.2 Academic Flexibility (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Number of Certificate/Value added courses offered and online courses of MOOCs, SWAYAM, NPTEL etc. where the students of the institution have enrolled and successfully completed during the last five years<hr>

                            1.2.1.1: Number of Certificate/Value added courses offered and online courses of MOOCs, SWAYAM, NPTEL etc. where the students of the institution have enrolled and successfully completed during the last five years: _____</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <tr>
                        <th scope="row">1.2.2</th>
                        <td>Percentage of students enrolled in Certificate/ Value added courses and also completed online courses of MOOCs, SWAYAM, NPTEL etc.
                            as against the total number of students during the last five years<hr>
                            1.2.2.1. Number of students enrolled in Certificate/ Value added courses and also completed online courses of MOOCs, SWAYAM, NPTEL etc. as against the total number of students during the last five years</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
                <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">1.3 Curriculum Enrichment (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Percentage of students undertaking projects work / field work / internships (Data for the latest completed academic year)<hr>

                            1.3.2.1. Number of students undertaking Project work/ field work/ internships</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
                <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">1.4 Feedback System (20)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <div class="mx-5">
                <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.1 Student Enrolment and Profile (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
                <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.2 Student Teacher Ratio (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.3 Teaching – Learning Process (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.4 Teacher Profile and Quality (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.5 Evaluation Process and Reforms (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">2.6 Student Performance and Learning Outcome (90)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Pass percentage of students during last five years.<hr>
            ...
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange"> 3.1 Grants</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Grants received from Government and Non-governmental agencies for research projects/ endowments in the institution during the last five years (INR in Lakhs)</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">3.2 Innovation Ecosystem (15)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Number of Workshops/Seminars/Conferences including on Research Methodology, Intellectual Property Rights (IPR) and Entrepreneurship conducted during the last five years</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">3.3 Research Publication and Awards (25)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">3.4 Extension Activities (40)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Number of extension and outreach programs conducted by the Institution through NSS/NCC/ Red cross/ YRC etc, (including the programmes such as Swachh Bharat, AIDS awareness, Gender issues etc and/or those organized in collaboration with industry, community and NGOs) during the last five years.</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">3.5 Collaboration (20)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>The number of MoUs, Collaborations/ Linkages for faculty exchange, Internship, Field trip, On-the-job training, research and other academic activities during the last five years</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">4.1 Physical Facilities (30)</h5> </h5></div>   
            <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Percentage of expenditure for infrastructure development and augmentation excluding salary during the last five years<hr>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">4.2 Library as a learning Resources (20)
            </h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">4.3 IT Infrastructure (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">4.4 Maintenance of Campus Infrastructure (20)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Percentage expenditure incurred on maintenance of physical facilities and academic support facilities excluding salary component, during the last five years
                            <hr>4.4.1.1 Expenditure incurred on maintenance of physical facilities and academic support facilities excluding salary component year wise during last five years (INR in lakhs)
                        </td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <!-- <tr>
            ...
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">5.1 Student Support (50)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Percentage of students benefited by scholarships and freeships provided by
                            the institution, government and non-government bodies, industries, individuals, philanthropists during the last five years.<hr>
                            5.1.1.1. Number of students benefited by scholarships and freeships provided by the institution, Government and non-government bodies, industries, individuals, philanthropists
                      ...
                      <tr>
                        ...
                        <td>Following capacity development and skills enhancement activities are organized for improving students’ capability<br>
                            1. Soft skills<br>
                      ...
                      <tr>
                        ...
                        <td> Percentage of students benefitted by guidance for competitive examinations and career counseling offered by the Institution during the last five years.<hr>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">5.2 Student Progression (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Percentage of placement of outgoing students and students progressing to
                            higher education during the last five years.<hr>
                            5.2.1.1 Number of outgoing students placed and / or progressed to higher education year wise during the last five years.<hr>
                            5.2.1.2. Number of outgoing students year wise during the last five years.<hr>
                        </td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <tr>
                        ...
                        <td>Percentage of students qualifying in state/national/ international
                            level examinations during the last five years. (eg: IIT/JAM/NET/SLET/GATE/GMAT/GPAT/CLAT/CAT/GRE/TOEFL/ IELTS/Civil Services/State government examinations etc.)</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      </tr>
                    </tbody>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">5.3 Student Participation and Activities (50)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Number of awards / medals for outstanding performance in sports / cultural actives at University / State / National / International level (award for a team event should be counted as one ) during the last five years.</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <tr>
                        <th scope="row">5.3.2</th>
                        <td>Average number of sports and cultural programs in which students of the Institution participated during last five years. (organised by the institution/other institutions)</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <tr>
                        <!-- <th scope="row"> </th> -->
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">5.4 Alumni Engagement (10)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">6.1 Institutional Vision and Leadership (10)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">6.2 Strategy Development and Deployment (10)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">1.1 Curricular Planning and Implementation (20)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Percentage of teachers provided with financial support to attend conferences/workshops and towards membership fee of professional bodies during the last five years.<hr>
                      ...
                      <tr>
                        <th scope="row">6.3.2</th>
                        <td>Percentage of teaching and non-teaching staff participating in Faculty development Programmes (FDP), professional development /administrative training programs during the last five years.<hr>
                            6.3.3.1.Total number of teaching and non-teaching staff participating in Faculty development Programmes (FDP), professional development /administrative training programs during the last five years.<hr>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">6.4 Financial Management and Resource Mobilization (15)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Institution has strategies for mobilization and optimal utilization of resources and funds from various sources (government/ nongovernment organizations) and it conducts financial audits regularly (internal and external)Institution has strategies for mobilization and optimal utilization of resources and funds from various sources (government/ nongovernment organizations) and it conducts financial audits regularly (internal and external)</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">6.5 Internal Quality Assurance System (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Quality assurance initiatives of the institution include:<br> 1. Regular meeting of Internal Quality Assurance Cell (IQAC); Feedback collected, analyzed and used for Improvements<br> 2. Collaborative quality initiatives with other institution(s)/membership of international networks <br>3. Participation in NIRF<br> 4. any other quality audit/accreditation recognized by state, national or international agencies such as NAAC, NBA,ISO Certification etc</td>
                        <td class="col3-view"><a href=""><u>View</u></a></td>
                      </tr>
                      <!-- <tr>
                        <th scope="row">1.2.2</th>
            ...
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">7.1 Institutional Values and Social Responsibilities (50)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">7.2 Best Practices (30)</h5> </h5></div>
                <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
            ...
            <hr>
            <div class="mx-5">
            <div class="row"><h5 class="blue pt5">Key Indicator - <h5 class="orange">7.3 Institutional Distinctiveness (20)</h5> </h5></div>
            <table class="table table-hover" border="1">
                    <thead>
                      <tr>
                        <th class="col1" scope="col">Metric NO.</th>
