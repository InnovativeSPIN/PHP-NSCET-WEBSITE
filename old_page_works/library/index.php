...
.header_lib::before {
  ...
  right: 0;
  bottom: 0;
  background-image: url('back lib.jpeg');
...
.carousel-control-next-icon {
  background-color: rgba(19, 69, 105, 0.8);
  border-radius: 50%;
  padding: 10px;
}
...
.carousel-control-next-icon:hover {
  background-color: rgba(19, 69, 105, 1);
}
  ...
  border-radius: 2px;
    ...
    .info-sections li:nth-child(odd) {
      float: left;
      
    }

    .info-sections li:nth-child(even) {
      float: right;
    }
...
<?php require_once("../../PHP-NSCET-WEBSITE/resources/header.php") ?>
      ...
      <div id="libraryCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner slides">
          <div class="carousel-item active slide">
            <img src="1.jpeg" alt="Library Image 1">
          </div>
          <div class="carousel-item slide">
            <img src="2.jpeg" alt="Library Image 2">
          </div>
          <div class="carousel-item slide">
            <img src="3.jpeg" alt="Library Image 3">
          </div>
          <div class="carousel-item slide">
            <img src="4.jpeg" alt="Library Image 5">
          </div>

          <div class="carousel-item slide">
            <img src="5.jpeg" alt="Library Image 5">
          </div>
    ...
    <div class="row align-items-center">
      <div class="col-md-5">
        <div class="librarian-container">
          <img src="Sinthan.jpg" alt="Dr. Sinthan">
          <div class="name">
...
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="1.jpeg" class="fancybox" rel="ligthbox">
        <img src="1.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="2.jpeg" class="fancybox" rel="ligthbox">
        <img src="2.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="3.jpeg" class="fancybox" rel="ligthbox">
        <img src="3.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="4.jpeg" class="fancybox" rel="ligthbox">
        <img src="4.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="5.jpeg" class="fancybox" rel="ligthbox">
        <img src="5.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="6.jpeg" class="fancybox" rel="ligthbox">
        <img src="6.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="7.jpeg" class="fancybox" rel="ligthbox">
        <img src="7.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
<div class="col-lg-3 col-md-4 col-xs-6 thumb">
    <a href="back lib.jpeg" class="fancybox" rel="ligthbox">
        <img src="back lib.jpeg" class="zoom img-fluid" alt="">
    </a>
</div>
...
<?php require_once("../../PHP-NSCET-WEBSITE/resources/footer.php") ?>
